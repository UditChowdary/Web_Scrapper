import {
  ...
  src_exports2,
  timer
} from "./chunk-4WRMEGVR.js";
import {
  animate,
  style,
  transition,
  trigger
} from "./chunk-6S6SKLEY.js";
import {
  CommonModule,
  NgForOf,
  NgIf,
  NgTemplateOutlet
} from "./chunk-DKIY4UIY.js";
    ...
    var Configuration = (function() {
      ...
      Configuration2.prototype.rootMerges = function(k) {
        ...
        for (var i = 0, i_ = n - 1; i < i_; ++i) {
          for (var j = i + 1; j < n; ++j) {
            var a2 = rs[i], b = rs[j];
            merges[ctr] = { id: ctr, nEdges: this.nEdges(a2, b), a: a2, b };
            ctr++;
          }
        }
        return merges;
    ...
    var Block = (function() {
      ...
      Block2.prototype.findMinLMBetween = function(lv, rv) {
        ...
        this.findPath(lv, null, rv, function(c2, next) {
          if (!c2.equality && c2.right === next && (m2 === null || c2.lm < m2.lm))
            m2 = c2;
        });
        return m2;
      };
      ...
      Block2.prototype.isActiveDirectedPathBetween = function(u, v) {
        ...
        while (i--) {
          var c2 = u.cOut[i];
          if (c2.active && this.isActiveDirectedPathBetween(c2.right, v))
            return true;
        }
        return false;
      };
  ...
  "node_modules/webcola/dist/src/rectangle.js"(exports) {
    ...
    function computeGroupBounds(g) {
      ...
      if (typeof g.groups !== "undefined")
        g.bounds = g.groups.reduce(function(r, c2) {
      ...
      Layout2.prototype.alpha = function(x3) {
        if (!arguments.length)
          ...
          if (this._alpha) {
            ...
            if (!this._running) {
              this._running = true;
              this.trigger({ type: EventType.start, alpha: this._alpha = x3 });
              this.kick();
            }
          }
          return this;
    ...
    var GridRouter = (function() {
      ...
      GridRouter2.getSegmentSets = function(routes, x3, y3) {
        ...
        for (var i = 0; i < vsegments.length; i++) {
          ...
          if (!segmentset || Math.abs(s[0][x3] - segmentset.pos) > 0.1) {
            segmentset = { pos: s[0][x3], segments: [] };
      ...
      GridRouter2.nudgeSegs = function(x3, y3, routes, segments, leftOf, gap) {
        ...
        vs.forEach(function(v, i2) {
          ...
          if (s.i > 0)
            route[s.i - 1][1][x3] = pos;
          if (s.i < route.length - 1)
            route[s.i + 1][0][x3] = pos;
        });
      };
      GridRouter2.nudgeSegments = function(routes, x3, y3, leftOf, gap) {
        ...
        for (var i = 0; i < vsegmentsets.length; i++) {
          ...
          for (var j = 0; j < ss.segments.length; j++) {
            var s = ss.segments[j];
            events.push({ type: 0, s, pos: Math.min(s[0][y3], s[1][y3]) });
            events.push({ type: 1, s, pos: Math.max(s[0][y3], s[1][y3]) });
          }
      ...
      GridRouter2.prototype.route = function(s, t) {
        ...
        var bendPenalty = function(u2, v2, w) {
          ...
          if (a2.node === source && a2.node === b.node || b.node === target && b.node === c2.node)
            return 0;
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function GraphComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        ...
        }, ɵɵresolveDocument)("mousedown", function GraphComponent_mousedown_HostBindingHandler($event) {
          return ctx.onMouseDown($event);
        }, ɵɵresolveDocument)("click", function GraphComponent_click_HostBindingHandler($event) {
          return ctx.graphClick($event);
        }, ɵɵresolveDocument)("touchmove", function GraphComponent_touchmove_HostBindingHandler($event) {
          return ctx.onTouchMove($event);
        }, ɵɵresolveDocument)("mouseup", function GraphComponent_mouseup_HostBindingHandler($event) {
